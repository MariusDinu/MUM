     ...
     echo   "<div class='header-middle-area'>
            <div class='main-nav'>
                ...
                <li class='Home'>
                    ...
                    <li class='Home'>
                        <a id='Useri'  >
                            <svg id='icon-nav-videos' viewBox='0 0 40 40'><g clip-path='url(#clip0)'><  path('M 50.86 0 a 50 50 0 0 0 -33 88.22 a 13 13 0 0 1 2.37 -1.69 l 14.89 -8.13 a 6.08 6.08 0 0 0 3.17 -5.34 v -6.12 a 33.19 33.19 0 0 1 -6 -12.51 a 5 5 0 0 1 -2.31 -4.21 v -6.69 a 5 5 0 0 1 1.67 -3.71 v -9.67 s -2 -15.06 18.4 -15.06 S 68.4 30.15 68.4 30.15 v 9.67 a 5 5 0 0 1 1.67 3.71 v 6.69 A 5 5 0 0 1 66.51 55 a 36.72 36.72 0 0 1 -5 10 c -0.55 0.77 -1.06 1.43 -1.51 1.94 v 6.27 a 6.1 6.1 0 0 0 3.37 5.45 l 16 8 A 13.06 13.06 0 0 1 82 88.41 A 50 50 0 0 0 50.86 0 Z');
                            ></g></svg>
                            <span>Useri</span>
                        </a>
