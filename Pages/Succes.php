...
<form class="form-horizontal" action="/MUM/Pages/Login.php">

<div style="text-align:center;">

<label> <p> Te-ai inregistrat cu succes! </p> </label>
<label> <p>  Login in contul tau! </p> </label>
<button type="submit" id="login-after-registration" value="login" class="button-Start">Login</button>
